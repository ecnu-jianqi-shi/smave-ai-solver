foreach(required REPORT REPEAT_REPORT)
    if(NOT DEFINED ${required} OR NOT EXISTS "${${required}}")
        message(FATAL_ERROR "missing FMI event artifact: ${required}")
    endif()
endforeach()
execute_process(
...
if(NOT compare_result EQUAL 0)
    message(FATAL_ERROR "FMI event smoke reports are not deterministic")
endif()
file(READ "${REPORT}" report)
foreach(pattern
    "MODEL \"SMAVEEventCS\""
    "INTERFACE \"CoSimulation\" \"SMAVEEventCS\""
    "SUCCESS 1"
    "SAMPLE 0 1 \"y\" 6"
    ...
    if(found EQUAL -1)
        message(FATAL_ERROR "FMI event report missing: ${pattern}")
    endif()
endforeach()
message(STATUS "FMI Co-Simulation event-mode fixed point and determinism passed")
